namespace Client
{
    ...
    {
        public static readonly byte[] DISABLE_DEVICE = new byte[] { 0x00, 0x00, 0x00, 0x00 };
        public static readonly byte[] GET_REAL_TIME_EVENT = new byte[] { 0x01, 0x00, 0x00, 0x00 };
        public static readonly byte[] GET_ATTENDANCE_LOGS = new byte[]
        {
        0x01, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
        };
        public static readonly byte[] GET_USERS = new byte[]
        {
