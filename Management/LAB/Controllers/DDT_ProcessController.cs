...
namespace Management.Controllers
{
    public class DDT_ProcessController : Controller
    {
        ...
        public async Task<IActionResult> Process()
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatient_Flexible(from, to, _DDT, "process");
        ...
        public async Task<IActionResult> Refresh()
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatientByPidOrSid_New(from, to, false, true, false, null, _DDT);
        ...
        public async Task<IActionResult> Search(string pidorseq, DateTime timeSearchFrom, DateTime timeSearchTo)
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatientByPidOrSid_New(from, to, false, true, false, pidorseq, _DDT);
        ...
        public async Task<IActionResult> ValidPrint([FromBody] ResultCDHAModel resultCDHA)
        {
            if (resultCDHA != null)
            {
                ...
                {
                    if (await _resultCDHABL.ValidateCDHAAsync(resultCDHA, _DDT, _userLogin.Value, _dateTime))
                    {
