...
{
    public class DDT_ReturnResultController : Controller
    {
        public readonly ILogger<DDT_ReturnResultController> _logger;
        ...
        public DDT_ReturnResultController(ILogger<DDT_ReturnResultController> logger, PatientCDHABL patientBL, ObjectBL objectBL, LocationBL locationBL,
        ...
        public async Task<IActionResult> ReturnResult()
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatient_Flexible(from, to, _DDT, "valid");
        ...
        public async Task<IActionResult> Get_Count()
        {
            ...
            var countGetSample = await _patientCDHABL.Get_CountPatient_New(from, to, true, false, false, _DDT);
            var countProcess = await _patientCDHABL.Get_CountPatient_New(from, to, false, true, false, _DDT);
            var countReturnResult = await _patientCDHABL.Get_CountPatient_New(from, to, false, false, true, _DDT);
        ...
        public async Task<IActionResult> Refresh()
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatientByPidOrSid_New(from, to, false, false, true, null, _DDT);
            SaveSearchDatesToSession(from, to);

            return PartialView("_DDT_ReturnResult_ListPatient");
        }
        ...
        public async Task<IActionResult> Search(string pidorseq, DateTime timeSearchFrom, DateTime timeSearchTo)
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatientByPidOrSid_New(from, to, false, false, true, pidorseq, _DDT);
        ...
        public async Task<IActionResult> GetPatientInfo(long id)
        {
            ...
            return PartialView("_DDT_ReturnResult_PatientInfo");
        }
        ...
        public async Task<IActionResult> GetServiceForPatient(long patientId)
        {
            ...
            return PartialView("_DDT_ReturnResult_ListService");
        }
        ...
        //    var _process = await _patientCDHABL.GetSample_ProcessResult_ReturnResult(id, false, true, false, _userLogin.Value, _DDT);
