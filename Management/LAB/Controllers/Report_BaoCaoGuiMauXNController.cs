...
{
    public class Report_BaoCaoGuiMauXNController : Controller
    {
        
        public readonly ILogger<Report_BaoCaoGuiMauXNController> _logger;
        ...
        public Report_BaoCaoGuiMauXNController(ILogger<Report_BaoCaoGuiMauXNController> logger, PatientXNBL patientXNBL, LocationBL locationBL, ToolBL toolBL,
        ...
        public async Task<IActionResult> Search(DateTime from, DateTime to, string type, string location, long userid, string hospitalId)
        {
            ...
            return PartialView("_ReportGuiMauXN");
        }
