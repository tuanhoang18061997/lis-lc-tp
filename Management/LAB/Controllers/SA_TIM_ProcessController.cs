...
namespace Management.Controllers
{
    public class SA_TIM_ProcessController : Controller
    {
        ...
        public async Task<IActionResult> Process()
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatient(from, to, false, true, false, _SAT);
        ...
        public async Task<IActionResult> Refresh()
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatientByPidOrSid(from, to, false, true, false, null, _SAT);
        ...
        public async Task<IActionResult> Search(string pidorseq, DateTime timeSearchFrom, DateTime timeSearchTo)
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatientByPidOrSid(from, to, false, true, false, pidorseq, _SAT);
