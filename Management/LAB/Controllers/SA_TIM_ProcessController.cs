...
{
    public class SA_TIM_ProcessController : Controller
    {
        ...
        public SA_TIM_ProcessController(ILogger<SA_ProcessController> logger, PatientCDHABL patientCDHABL, ObjectBL objectBL, LocationBL locationBL,
        ...
        public async Task<IActionResult> Process()
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatient_Flexible(from, to, _SAT, "process");
            ViewData["lstUser"] = await _userBL.GetListUser(UserTypeModel.SAT);
            ViewData["lstBenhAnModel"] = await BenhAnModel.GetListBenhAnModel();
            ViewData["lstSampleResult"] = await _sampleBL.GetListSampleByCategory(_SAT);
        ...
        public async Task<IActionResult> Refresh()
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatientByPidOrSid_New(from, to, false, true, false, null, _SAT);

            return PartialView("_SA_TIM_Process_ListPatient");
        }
        ...
        public async Task<IActionResult> Search(string pidorseq, DateTime timeSearchFrom, DateTime timeSearchTo)
        {
            ...
            ViewData["lstPatient"] = await _patientCDHABL.Get_ListPatientByPidOrSid_New(from, to, false, true, false, pidorseq, _SAT);
        ...
        public async Task<IActionResult> GetSample(long id)
        {
            ...
            var _getSample = await _patientCDHABL.GetSample_ProcessResult_ReturnResult(id, true, false, false, _userLogin.Value, _SAT);
        ...
        public async Task<IActionResult> GetPatientInfo(long id)
        {
            ...
            return PartialView("_SA_TIM_Process_PatientInfo");
        }
        ...
        public async Task<IActionResult> GetServiceForPatient(long patientId)
        {
            ...
            return PartialView("_SA_TIM_Process_ListService");
        }
        ...
        public async Task<IActionResult> GetImageForService_SieuAmTim(long id)
        {
            try
            {
                ...
                if (_resultCDHA != null)
                {
                    ...
                    var _sieuamtim = new SieuAmTimModel();
                    if (!string.IsNullOrEmpty(_resultCDHA.SieuAmTim))
                    {
                        _sieuamtim = (JsonConvert.DeserializeObject<SieuAmTimModel>(_resultCDHA.SieuAmTim));
                    }
        ...
        public async Task<IActionResult> SaveResult([FromBody] ResultCDHAModel resultCDHA)
        {
            ...
            if (resultCDHA != null)
            {
                ...
                await _patientCDHABL.Update(resultCDHA.patientId, resultCDHA.returnResultTime, resultCDHA.userReturnResult, _userLogin.Value, _dateTime, _SAT);
                    ...
                    if (await _resultCDHABL.ValidateCDHAAsync(resultCDHA, _SAT, _userLogin.Value, _dateTime))
                    {
                        ...
                        if (_result != null)
                        {
                            try
                            {
                                ...
                                //var fileBase64 = await _toolBL.ExportPdf_Result_Landscape_OnePage_FromFiles(_folder, _file, header, content_result, content_image, footer, Path.Combine(_environment.WebRootPath, "pdf_templates", "Landscape2ColRaw_SAT.html"));
