...
{
    public class NS_ReturnResultController : Controller
    {
        public readonly ILogger<NS_ReturnResultController> _logger;
        ...
        public NS_ReturnResultController(ILogger<NS_ReturnResultController> logger, PatientCDHABL patientBL, ObjectBL objectBL, LocationBL locationBL,
        ...
        public async Task<IActionResult> GetPatientInfo(long id)
        {
            ...
            return PartialView("_NS_ReturnResult_PatientInfo");
        }
        ...
        public async Task<IActionResult> GetServiceForPatient(long patientId)
        {
            ...
            return PartialView("_NS_ReturnResult_ListService");
        }
        ...
        //    var _process = await _patientCDHABL.GetSample_ProcessResult_ReturnResult(id, false, true, false, _userLogin.Value, _NS);
        ...
        public async Task<IActionResult> Invalid([FromBody] InvalidRequestModel request)
        {
            try
            {
                ...
                {
                    var categoryCode = request.CategoryCode ?? _NS;
