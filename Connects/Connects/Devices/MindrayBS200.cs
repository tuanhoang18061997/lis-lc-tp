...
{
    public class MindrayBC20s_IP_Server
    {
        private static readonly ILog log4net = LogManager.GetLogger(typeof(MindrayBC20s_IP_Server).Name);
        ...
        public static void ServerReceive(System.Object obj)
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    if (isWriteFile) Folder_File_Tool.Create_Write_File(typeof(MindrayBC20s_IP_Server).Name, true, dataRemovedByteNull);
