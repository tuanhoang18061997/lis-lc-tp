...
{
    public class MindrayBS240E_IP_SERVER
    {
        private static string className = typeof(MindrayBS240E_IP_SERVER).Name;
        private static readonly ILog log4net = LogManager.GetLogger(typeof(MindrayBS240E_IP_SERVER).Name);
