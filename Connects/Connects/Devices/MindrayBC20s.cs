...
{
    public class MindrayBC20s
    {
        private static string className = typeof(MindrayBC20s).Name;
        private static readonly ILog log4net = LogManager.GetLogger(typeof(MindrayBC20s).Name);
