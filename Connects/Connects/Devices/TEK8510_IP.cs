...
{
    public class TEK8510_IP
    {
        private static readonly ILog log4net = LogManager.GetLogger(typeof(TEK8510_IP).Name);
        ...
        public static void ServerReceive(System.Object obj)
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    if(isWriteFile) Folder_File_Tool.Create_Write_File(typeof(TEK8510_IP).Name, true, dataRemovedByteNull);
